...
export const GET_SUBCOMMENT = 'COMMENT/GET_SUBCOMMENT';
export const CREATE_SUBCOMMENT = 'COMMENT/CREATE_SUBCOMMENT';
...
export const GET_SUBCOMMENT_SUCCESS = 'COMMENT/GET_SUBCOMMENT_SUCCESS';
export const GET_SUBCOMMENT_ERROR = 'COMMENT/GET_SUBCOMMENT_ERROR';

export const CREATE_SUBCOMMENT_SUCCESS = 'COMMENT/CREATE_SUBCOMMENT_SUCCESS';
export const CREATE_SUBCOMMENTCOMMENT_ERROR = 'COMMENT/CREATE_SUBCOMMENT_ERROR';
